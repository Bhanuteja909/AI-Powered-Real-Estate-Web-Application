...
export default function UpdateListing() {
  ...
  const CLOUDINARY_UPLOAD_PRESET = 'profile_images'; // ⬅️ Replace with your actual preset
    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
          <input type='text' id='name' maxLength='62' minLength='10' required className='border p-3 rounded-lg' placeholder='Name' onChange={handleChange} value={formData.name} />
          <textarea id='description' required className='border p-3 rounded-lg' placeholder='Description' onChange={handleChange} value={formData.description} />
          <input type='text' id='address' required className='border p-3 rounded-lg' placeholder='Address' onChange={handleChange} value={formData.address} />
          ...
          <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
              <input type='number' id='regularPrice' min='50' max='30000000' required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange} value={formData.regularPrice} />
            ...
            {formData.offer && (
              <div className='flex items-center gap-2'>
                <input type='number' id='discountPrice' min='0' max='30000000' required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange} value={formData.discountPrice} />
                <div className='flex flex-col items-center'>
